...
.gl-featured__item {
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,0.75), 0 4px 16px rgba(91,63,45,0.08);
  transition: transform 0.25s ease, box-shadow 0.25s ease;
}
.gl-featured__item:hover {
  transform: translateY(-4px);
  box-shadow: inset 0 1px 0 rgba(255,255,255,0.75), 0 12px 32px rgba(91,63,45,0.14);
}
...
.gl-featured__placeholder { width:100%; height:100%; background: linear-gradient(135deg, rgba(190, 157, 121, 0.28), rgba(154, 174, 142, 0.25)); }
...
.gl-featured__name { font-size: 0.78rem; color: rgba(61,47,38,0.82); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 80%; }
.gl-featured__arrow { font-size: 0.85rem; color: var(--maroon, #8a5a44); transition: transform 0.2s; }
