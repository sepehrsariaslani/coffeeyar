...
.featured__grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 1px; background-color: #E8E4DE; border: 1px solid #E8E4DE; }
...
.featured__arrow { font-size: 0.85rem; color: #9e9890; transition: transform 0.2s; }
.featured__item:hover .featured__arrow { transform: translateX(-4px); color: #800000; }
</style>
