...
<style scoped>
.hero { position: relative; min-height: 72vh; display: flex; align-items: flex-end; background-color: var(--background, #F5F3F0); overflow: hidden; border-bottom: 1px solid var(--border, #E8E4DE); }
...
.hero__eyebrow { font-size: 0.75rem; letter-spacing: 0.18em; text-transform: uppercase; color: var(--muted-foreground, #7a7166); margin-bottom: 1rem; }
.hero__title { font-size: clamp(2.4rem, 6vw, 4.5rem); font-weight: 300; color: var(--foreground, #111); line-height: 1.15; margin: 0 0 1rem; letter-spacing: -0.02em; }
.hero__subtitle { font-size: 1rem; color: var(--muted-foreground, #6b6560); line-height: 1.7; margin-bottom: 2.5rem; max-width: 420px; font-weight: 300; }
.hero__cta { display: inline-flex; align-items: center; gap: 0.6rem; font-size: 0.875rem; letter-spacing: 0.06em; color: var(--maroon, #800000); text-decoration: none; border-bottom: 1px solid var(--maroon, #800000); padding-bottom: 2px; transition: gap 0.25s ease; }
...
.hero-split__text { display: flex; flex-direction: column; justify-content: center; padding: 5rem 5vw; background-color: var(--background, #F5F3F0); border-bottom: 1px solid var(--border, #E8E4DE); }
.hero-split__media { position: relative; overflow: hidden; }
.hero-split__img { width: 100%; height: 100%; object-fit: cover; }
.hero-split__placeholder { width: 100%; height: 100%; background: linear-gradient(135deg, var(--border, #E8E4DE), #D5CFC8); }
.hero-split__eyebrow { font-size: 0.7rem; letter-spacing: 0.2em; text-transform: uppercase; color: var(--muted-foreground, #7a7166); margin-bottom: 1.25rem; }
.hero-split__title { font-size: clamp(2rem, 4vw, 3.5rem); font-weight: 300; color: var(--foreground, #111); line-height: 1.2; margin: 0 0 1rem; letter-spacing: -0.02em; }
.hero-split__sub { font-size: 0.95rem; color: var(--muted-foreground, #6b6560); line-height: 1.75; margin-bottom: 2.5rem; max-width: 380px; font-weight: 300; }
.hero-split__cta { display: inline-flex; align-items: center; gap: 0.6rem; font-size: 0.875rem; letter-spacing: 0.06em; color: var(--maroon, #800000); text-decoration: none; border-bottom: 1px solid var(--maroon, #800000); padding-bottom: 2px; transition: gap 0.25s ease; width: fit-content; }
.hero-split__cta:hover { gap: 1rem; }
.hero-split__media::before { content: ''; position: absolute; inset: 0; background: linear-gradient(to left, transparent 70%, var(--background, #F5F3F0) 100%); z-index: 1; }
