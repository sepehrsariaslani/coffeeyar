import{A as f,q as i,B as n}from"./index-DY0q-1or.js";const o="navar-policies-v1",v={terms:{title:"شرایط و ضوابط استفاده",content:`با استفاده از این وب‌سایت، شما موافقت خود را با شرایط زیر اعلام می‌کنید.
...
- برای مناطق دورافتاده ممکن است زمان بیشتری طول بکشد.`}},p=f("policies",()=>{const t=i(JSON.parse(JSON.stringify(v))),c=i(!1);async function s(){try{const e=await n.policies.get();e&&typeof e=="object"&&(Object.keys(e).forEach(a=>{t.value[a]&&(t.value[a]={...t.value[a],...e[a]})}),localStorage.setItem(o,JSON.stringify(t.value)))}catch{const e=l();e&&Object.keys(e).forEach(a=>{t.value[a]&&(t.value[a]={...t.value[a],...e[a]})})}c.value=!0}function l(){try{const e=localStorage.getItem(o);return e?JSON.parse(e):null}catch{return null}}async function r(){try{await n.admin.policies.update(t.value)}catch{}}function u(){localStorage.setItem(o,JSON.stringify(t.value)),r()}return s(),{policies:t,loaded:c,save:u}});export{p as u};
